...
<ul id="slide-out" class="side-nav fixed leftside-navigation">
    <li class="user-details cyan darken-2">
        <div class="row">
            ...
            <div class="col col s12 m12 l12">
                ...
                <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown">Jeffrey Alvarado<i class="mdi-navigation-arrow-drop-down right"></i></a>
    ...
    <li class="no-padding">
        <ul class="collapsible collapsible-accordion">
            ...
            <!--</li>-->
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-all"></i> Documents <span class="new badge"></span></a>
            </li>
            <li class="bold"><a href="page-subir-archivo.php" class="waves-effect waves-cyan"><i class="mdi-device-now-widgets"></i> Upload Document <span class="new badge"></span></a>
            </li>
            <!--<li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-editor-border-all"></i> Tables</a>-->
            <!--    <div class="collapsible-body">-->
            <!--        <ul>-->
            <!--            <li><a href="table-basic.php">Documentos</a>-->
            <!--            </li>-->
            <!--            <li><a href="table-data.php">Data Tables</a>-->
            <!--            </li>-->
            <!--        </ul>-->
            <!--    </div>-->
            <!--</li>-->
            <li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="mdi-editor-insert-comment active"></i> Forms</a>
                <div class="collapsible-body">
                    <ul>
                        <li><a href="form-elements.php">Form Elements</a>
                        </li>
                        <li class="active"><a href="form-layouts.php">Form Layouts</a>
                        </li>
                    </ul>
                </div>
            </li>
